...
| 3. Implement a Darcs backend for metadata and diffs | ✅ Completed | Darcs detection now surfaces metadata via `collect_darcs_info`, rollouts persist revision-control summaries, and the TUI diff viewer delegates to the shared Darcs workspace diff helper.【F:codex-rs/core/src/revision_control/darcs.rs†L62-L188】【F:codex-rs/core/src/rollout/recorder.rs†L28-L368】【F:codex-rs/protocol/src/protocol.rs†L968-L1090】【F:codex-rs/tui/src/get_repo_diff.rs†L1-L94】 |
...
| 9. Build automated test coverage for Darcs | ⏳ In progress | Added metadata/diff integration tests, Darcs snapshot round-trip coverage, and ensured rollouts persist Darcs metadata; CI matrix work still outstanding.【F:codex-rs/core/tests/suite/revision_control_darcs.rs†L1-L220】【F:codex-rs/git-tooling/src/lib.rs†L1-L220】 |
