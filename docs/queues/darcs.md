...
| 6–9. Remaining roadmap items | ⏳ Not started | No code paths or docs reference Darcs onboarding text, sandbox integration, environment detection, docs updates, or CI coverage yet. |
